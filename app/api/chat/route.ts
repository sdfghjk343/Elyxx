...
try {
  ...
  try {
    ...
    const { text } = await generateText({
      model: mistral("mistral-small", { apiKey: MISTRAL_API_KEY }),
      prompt,
      system: "Sei un assistente AI utile, rispettoso e onesto. Rispondi sempre nel modo più utile possibile, mantenendo un tono amichevole.",
      maxTokens: 1000,
    })
